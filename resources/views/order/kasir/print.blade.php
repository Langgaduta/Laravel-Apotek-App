...
<body>
    ...
    <div id="receipt">
        ...
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal"><strong>Terimakasih atas pembelian anda!</strong>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci molestiae nesciunt distinctio officiis quis ab dignissimos accusamus sint porro.</p>
            </div>
        </div>
    </div>
</body>
